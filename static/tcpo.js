...
function save_tcpo_settings_resp(data)
{
    var resp = eval('(' + data + ')');
...
function save_tcpo_settings()
{
    $("#save_btn").attr("disabled", "disabled");

    var settings_to_save = jQuery("form").serialize();
    settings_to_save += "&cmd=save_tcpo_settings";
    send_ajax_req(settings_to_save, save_tcpo_settings_resp);
    return false;
}
